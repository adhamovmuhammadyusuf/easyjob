    ...
    <footer className="bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">EasyJob</h3>
            <p className="text-gray-600">
              O'zbekistondagi eng yaxshi ish topish platformasi
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Kompaniya</h3>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Xizmatlar</h3>
            <ul className="space-y-2">
              <li>
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Ijtimoiy tarmoqlar</h3>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-center text-gray-400">
            &copy; {new Date().getFullYear()} EasyJob. Barcha huquqlar himoyalangan.
          </p>
        </div>
      </div>
    </footer>
