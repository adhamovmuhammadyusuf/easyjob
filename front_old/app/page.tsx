...
import type { Job, Company } from '@/lib/api/types';
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const jobsUrl = 'http://localhost:8000/api/v1/vacancies/featured/';
        const companiesUrl = 'http://localhost:8000/api/v1/companies/popular/';
        ...
        const [jobsResponse, companiesResponse] = await Promise.all([
          ...
          fetch(companiesUrl, fetchOptions)
        ]);
