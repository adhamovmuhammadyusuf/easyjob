    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">EasyJob</h3>
            <p className="text-gray-300 text-sm">
              Find your dream job or the perfect candidate with EasyJob - the modern job marketplace connecting talented individuals with great companies.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-300">
                <span className="font-medium">Email:</span> info@easyjob.com
              </li>
              <li className="text-gray-300">
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} EasyJob. All rights reserved.
            </p>
