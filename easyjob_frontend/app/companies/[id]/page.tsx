            ...
            <CardTitle className="flex items-center justify-between">
              ...
              {jobs.length > 0 && (
                <Button variant="outline" size="sm" asChild>
                  <Link href={`/jobs?company=${company.id}`}>View All</Link>
                </Button>
              )}
            </CardTitle>
          </CardHeader>
          <CardContent>
            {jobsLoading ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-500">This company doesn't have any job openings at the moment.</p>
              </div>
            ) : (
              <div className="space-y-4">
                ...
                {jobs.length > 5 && (
                  <div className="text-center pt-4">
                    <Button variant="outline" asChild>
                      <Link href={`/jobs?company=${company.id}`}>View All {jobs.length} Positions</Link>
                    </Button>
                  </div>
                )}
              </div>
